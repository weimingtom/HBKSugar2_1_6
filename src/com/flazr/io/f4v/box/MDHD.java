...
public class MDHD implements Payload {
    ...
    private static final String TAG = MDHD.class.getSimpleName();
    ...
    public void read(ChannelBuffer in) {
        ...
        if (D) {
        	Log.d(TAG, "creationTime " + creationTime + " modificationTime " + modificationTime + " timeScale " + timeScale + " duration " + duration);
        }
        pad = in.readByte();
