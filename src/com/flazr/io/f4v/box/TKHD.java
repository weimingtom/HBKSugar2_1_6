...
public class TKHD implements Payload {
    ...
    private static final String TAG = TKHD.class.getSimpleName();
    ...
    public void read(ChannelBuffer in) {
        ...
        if (D) {
        	Log.d(TAG, "creationTime " + creationTime + " modificationTime " + modificationTime + " trackId " + trackId + " duration " + duration + " layer " + layer + " volume " + volume);
        }
